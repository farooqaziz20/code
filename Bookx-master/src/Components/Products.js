...
<section className="categories-icon section-padding bg-drack">
          ...
          <h1 className="section-title">Categories</h1>
            ...
            <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                  <div className="icon-box" onClick={()=>dispatch(filterProduct('TextBook'))}>
                    <div className="icon">
              ...
              <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                  <div className="icon-box" onClick={()=>dispatch(filterProduct('Novel'))}>
                    <div className="icon">
              ...
              <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                  <div className="icon-box" onClick={()=>dispatch(filterProduct('Magazine'))}>
                    <div className="icon">
              ...
              <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                  <div className="icon-box" onClick={()=>dispatch(filterProduct('Lectures'))}>
                    <div className="icon">
              ...
              <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                  <div className="icon-box"  onClick={()=>dispatch(allProducts(setLoading))}>
                    <div className="icon">
...
<a href="/product-details"><img className="img-responsive mx-auto d-block" src={products.avatar} alt="" height="200px" width="200px" /></a>
</figure>
